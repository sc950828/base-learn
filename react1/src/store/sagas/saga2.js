...
import { getTodoByIdType, fetchTodoByIdType2 } from "../types";
...
function* listenGetTodo() {
  yield takeEvery(fetchTodoByIdType2, fetchTodo); // 始终监听
  // yield takeLatest(fetchTodoByIdType2, fetchuserr); // 监听最新的一次
}

// 使用数组导出
const saga2 = [listenGetTodo()];
