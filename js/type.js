...
const typeOfTest = () => {
  ...
  console.log(
    "typeof function:",
    typeof new Function("say", 'console.log("say hi")')
  ); //function
...
const instanceofTest = () => {
  ...
  console.log(
    "BigInt('9007199254740991') instanceof Boolean:",
  ...
  console.log(
    "new Function('say', 'console.log('say hi')') instanceof Function:",
    new Function("say", 'console.log("say hi")') instanceof Function
  ); //true
  console.log(
...
const toStringCallTest = () => {
  ...
  console.log(
    "Object.prototype.toString.call(new Function('say', 'console.log('say hi')')):",
    Object.prototype.toString.call(new Function("say", 'console.log("say hi")'))
  ); //[object Function]
  console.log(
  ...
  console.log(
    ...
    Object.prototype.toString
      .call(new Function("say", 'console.log("say hi")'))
      .slice(7, -1)
  );
};
...
const constructorNameTest = () => {
  ...
  console.log("new Error().constructor.name:", new Error().constructor.name); //Error
...
const constructorTest = () => {
  ...
  console.log(
    "new Function().constructor.toString().indexOf('Function') > -1:",
    new Function().constructor.toString().indexOf("Function") > -1
  ); //true
  console.log(
  ...
  console.log(
    ...
    BigInt("12312321324234234234234").constructor.toString().indexOf("BigInt") >
      -1
  ); //true
  console.log(
...
// 2、其他值到字符串的转换规则
// 全局方法 String() 可以将其他值转换为字符串。或者使用隐式转换通过计算 + ""
...
const convertStringTest = () => {
  ...
  console.log("String(user):", String(user)); //[object Object]
  console.log(
    "String(new Error('customer error')):",
    String(new Error("customer error"))
  ...
  Animal.prototype.valueOf = function () {
    ...
    // return { name: "valueOf" };
    return "i am a dog"; //返回的是基本数据类型则将该值转换成String类型
  };
  const dog = new Animal("dog");
  console.log("String(dog):", String(dog)); //i am a dog
};
...
const convertNumberTest = () => {
  ...
  Animal.prototype.toString = function () {
    ...
    return "i am a dog"; //是基本数据类型 返回转换成Number数据类型得到NaN
  };
  Animal.prototype.valueOf = function () {
    console.log("valueOf 先调用"); //不是基本数据类型继续调用toString方法
    return { name: "valueOf" };
    // return "i am a dog";
  };
  const dog = new Animal("dog");
  console.log("Number(dog):", Number(dog)); //NaN
};
