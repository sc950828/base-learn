...
console.log("---copyWithin---", arr8, arr9);
...
const result5 = arr45.reduceRight((total, currentValue, currentIndex, arr) => {
  console.log(total, currentValue, currentIndex, arr);
});
console.log("---reduceRight---", result5); //undefined
// 有初始值，下标从数组的倒数第一个元素开始，total为初始值
const result6 = arr45.reduceRight((total, currentValue, currentIndex, arr) => {
  console.log(total, currentValue, currentIndex, arr);
}, 10);
console.log("---reduceRight---", result6); //undefined

// 有返回值
const result7 = arr45.reduceRight((total, currentValue, currentIndex, arr) => {
  console.log(total, currentValue, currentIndex, arr);
  return total + currentValue;
});
console.log("---reduceRight---", result7); //21
const result8 = arr45.reduceRight((total, currentValue, currentIndex, arr) => {
  console.log(total, currentValue, currentIndex, arr);
  return total + currentValue;
}, 0);
